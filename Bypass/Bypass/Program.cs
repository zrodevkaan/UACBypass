...
";
    ...
    {
        Process a = Process.Start("powershell.exe", "");

        a.OutputDataReceived += (sender, data) => Console.WriteLine(data.Data);
        a.ErrorDataReceived += (sender, data) => Console.WriteLine(data.Data);
